...
export default function Header() {
  return (
    <header className="App-header flex flex-col items-center gap-2 border-b-2 border-[var(--main-color)] bg-white px-5 py-4 text-center max-[912px]:pt-10 max-[520px]:gap-2 sm:flex-row sm:items-center sm:gap-5 sm:text-left">
      <img
        src={holbertonLogo}
        alt="holberton logo"
