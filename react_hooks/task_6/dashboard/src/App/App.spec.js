...
async function openNotificationsDrawer(user) {
  // Check whether the panel is already visible in any form (may show "No new notification" before data loads)
  const panelOpen =
    screen.queryByText(/here is the list of notifications/i) ||
    screen.queryByText(/no new notification for now/i)

  if (!panelOpen) {
    // Drawer is closed — click to open (TOGGLE_DRAWER: false → true)
